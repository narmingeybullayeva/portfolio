                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            {technologies.map((tech, index) => (
                                <div
                                    key={tech}
                                    className="bg-white p-4 rounded-xl shadow-md text-center hover:shadow-lg transform hover:scale-105 transition-all duration-300"
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-lg">
                            <h4 className="text-lg font-semibold text-gray-900 mb-3">What I Bring</h4>
